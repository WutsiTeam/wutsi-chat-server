[![](https://github.com/wutsi/wutsi-chat-server/actions/workflows/master.yml/badge.svg)](https://github.com/wutsi/wutsi-chat-server/actions/workflows/master.yml)
...
- Create a database named `wutsi-chat`
...
- Install
```
$ git clone git@github.com:wutsi/wutsi-chat-server.git
```

- Build
```
$ cd wutsi-chat-server
$ mvn clean install
```
...
# Links
- [API](https://wutsi.github.io/wutsi-chat-server/api/)
- [Documentation](docs/)
